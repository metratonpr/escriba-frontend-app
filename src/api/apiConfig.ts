...
export const API_DOCUMENT_TYPES = `${BASE_URL}/document-issuers`;
...
export const API_COMPANY_DOCUMENT_VERSION_UPLOADS = `${BASE_URL}/company-document-version-uploads`;
export const API_EMPLOYEE_DOCUMENT_VERSION_UPLOADS = `${BASE_URL}/employee-document-version-uploads`;
