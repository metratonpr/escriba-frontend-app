...
export const router = createBrowserRouter([
    ...
    },
    {
        ...
        children: [
            ...
            { path: 'empresas/documentos/visualizar-anexo/:attachmentId', element: <CompanyAttachmentViewerPage /> },



            // COLABORADORES - ORDEM CORRETA: mais específico primeiro
            { path: 'colaboradores', element: <EmployeesPage /> },
            { path: 'colaboradores/novo', element: <EmployeeForm /> },
            { path: 'colaboradores/editar/:id', element: <EmployeeForm /> },
